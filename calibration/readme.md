...
(idealized sensor would be flat line at 1)

Note: It turned out that due to a conversion error in library version <= 0.4.0, the columns uva_mw actually are uva\_uw (see <https://github.com/RobTillaart/AS7331/issues/8>).
